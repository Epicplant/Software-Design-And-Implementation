...
public final class RatTerm {
    ...
    public boolean isZero() {
        checkRep();
        boolean returner = !(coeff.isPositive() || coeff.isNegative());
        checkRep();
        return returner;
    }
    ...
    public double eval(double d) {
        if(this.isNaN()) {
            ...
            double coeffVal = coeff.doubleValue();
            double exptVal = Math.pow(d, expt);
            return coeffVal * exptVal;
        }
    ...
    public RatTerm negate() {
        ...
        if(this.isNaN()) {
            ...
            RatTerm returner = new RatTerm(coeff.negate(), expt);
            checkRep();
           return returner;
        }
    }
    ...
    public RatTerm add(RatTerm arg) {
        ...
        if(arg.isNaN() || this.isNaN()) {
            ...
            returner = new RatTerm(this.coeff.add(arg.coeff), expt);
        }
        checkRep();
        return returner;
    }
    ...
    public RatTerm sub(RatTerm arg) {
        checkRep();
        RatTerm returner = this.add(arg.negate());
        checkRep();
        return returner;
    }
    ...
    public RatTerm mul(RatTerm arg) {
        ...
        if(arg.isNaN() || this.isNaN()) {
            ...
            RatTerm returner = new RatTerm(this.coeff.mul(arg.coeff), this.expt + arg.expt);
            checkRep();
            return returner;
        }
    }
    ...
    public RatTerm div(RatTerm arg) {
        ...
        if(arg.isZero() || arg.isNaN() || this.isNaN()) {
            ...
            RatTerm returner =  new RatTerm(this.coeff.div(arg.coeff), this.expt - arg.expt);
            checkRep();
            return returner;
        }
    }
