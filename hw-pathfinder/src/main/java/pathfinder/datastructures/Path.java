 ...
 */
public class Path<E1> implements Iterable<Path<E1>.Segment> {
     ...
     */
    public Path<E1> extend(E1 newEnd, double segmentCost) {
        checkRep();
        //
        Path<E1> extendedPath = new Path<>(start);
     ...
     * are created as part of larger paths by calling Path#extend(E1, double).
     */
    public class Segment {
         ...
         */
        private final E1 start;

        /**
         * The end of this segment.
         */
        private final E1 end;
         ...
         */
        private Segment(E1 start, E1 end, double cost) {
         ...
         */
        public E1 getStart() {
            // Note: Since E1 is no longer required to be immutable this doesn't prevent rep exposure
            return this.start;
        }
