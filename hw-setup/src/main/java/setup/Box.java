...
public class Box implements Iterable<Ball> {
    ...
    /**
     * maxVolume is used to determine how much a box can hold.
     */
    ...
    public Iterator<Ball> getBallsFromSmallest() {
        ...
        Set<Ball> balls = new TreeSet<>(new Comparer());
    ...
    /**
     *   * A comparator class for getBallsFromSmallest used to
     *   * sort balls.
     *
     */

    private static class Comparer implements Comparator<Ball> {

        /**
         *      *Takes 2 balls and returns which one of them has a greater volume.
         *
         *      * @param e1 Ball to be compared to e2 Ball.
         *      * @return returns 0 if balls' volumes are the same, 1 if e1 has a greater volume than e2,
         *      * and -1 if e1 has a smaller volume than e2.
         *      * @spec.requires e1 != null && e2 != null.
         *
         */
        @Override public int compare(Ball e1, Ball e2)
        {
            if(e1.getVolume() == e2.getVolume()) {
                return 0;
            } else if (e1.getVolume() > e2.getVolume()) {
                return 1;
            } else {
                return -1;
            }
